...
app.layout = html.Div([
    ...
    style = {'textAlign': 'center', 'color': '#503D36', 'font-size': '24px'}),#Include style for title
...
# Plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(
            figure=px.line(yas, 
                x='Year',
                y='Automobile_Sales',
                title="Average Yearly Automobile Sales Fluctuation"))
...
# Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(
            ...
            values='Advertising_Expenditure',
            names='Vehicle_Type',
            title='Total Advertisment Expenditure for Each Vehiclein the year {}'.format(input_year)))
